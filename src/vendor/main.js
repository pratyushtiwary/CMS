...
import styles from "../styles/vendor/Main.module.css";
import first from "../assets/vendor/main/first.png";
import second from "../assets/vendor/main/second.png";
...
export default function Main(props) {
  ...
  useEffect(() => {
    ...
    hit("api/vendor/getComplaintsByStatus", {
      token: token,
    }).then((c) => {
      if (c.success) {
  ...
  return (
    <>
      ...
      <Header
        title="Dashboard"
        items={["Announcements", "Complaints", "Settings"]}
        links={["/announcements", "/complaints", "/settings"]}
        icons={["campaign", "segment", "settings"]}
        hideNewComplaint
      />
          ...
          <div className={styles.notFound}>
            ...
            <div className={styles.msg}>
              ...
              <Typography variant="subtitle2" className={styles.subtitle}>
                To register a complaint click on the "+" button above
              </Typography>
            </div>
          </div>
        )}
        {!complaints && complaintStatLoaded === null && !maxWidth && (
          <div className={styles.notFound}>
            ...
            <div className={styles.msg}>
              ...
              <Typography variant="subtitle2" className={styles.subtitle}>
                To register a complaint click on the "New Complaint" button
                above
              </Typography>
            </div>
          </div>
