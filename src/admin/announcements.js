...
export default function Announcements(props){
	...
	return (
		<>
			...
			<Header
				title = "Announcements"
				items = {["Home","New User","New Announcement","New Department","Departments","users","Users","Settings"]}
				links = {["/","/new_user","/new_announcement","/new_department","/departments","/users","/users","/settings"]}
